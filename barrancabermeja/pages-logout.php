...
<!-- Mirrored from coderthemes.com/hyper_2/saas/pages-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 17:04:11 GMT -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <h4 class="text-dark-50 text-center mt-0 fw-bold">Registro exitoso !</h4>
                                <p class="text-muted mb-4">Creaste una nueva cuenta, genial.</p>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    <p class="text-muted"> <a href="login.php" class="text-muted ms-1"><b>Iniciar
                                                Sesion</b></a></p>
                                </div> <!-- end col -->
                            </div>
                            <!-- end row -->
